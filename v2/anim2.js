...
lib.ssMetadata = [
		{name:"2_index_atlas_P_1", frames: [[0,0,1280,720]]},
		{name:"2_index_atlas_NP_1", frames: [[0,0,1304,720]]}
];
...
(lib.f1 = function() {
	this.initialize(ss["2_index_atlas_NP_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.videoframe_2 = function() {
	this.initialize(ss["2_index_atlas_P_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
}).prototype = getMCSymbolPrototype(lib.Symbol72, new cjs.Rectangle(-434.6,-240,869.3,480), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_14.graphics.f("#FFFFFF").s().p("AglApIAFgJQAGAFAHAAQAIAAAFgLIACgFIgehDIANAAIAXA2IAYg2IAMAAIgiBKQgEALgFAFQgGADgIAAQgLAAgHgGg");
	...
	this.shape_16.graphics.f("#FFFFFF").s().p("AATAiIAAgVIgTAAIgBAAIgPAVIgOAAIARgXQgQgFAAgQQAAgLAIgHQAIgFANAAIAfAAIAABDgAgQgJQAAANAQAAIATAAIAAgaIgSAAQgRAAAAANg");
	...
	this.shape_20.graphics.f("#FFFFFF").s().p("AgWAdQgHgFAAgJQAAgTAcAAIATAAIAAgDQAAgRgSAAQgNAAgJAIIgFgJQALgJAQAAQAeAAAAAcIAAAoIgMAAIAAgJQgGAKgQAAQgLAAgHgGgAgRAOQABAFADADQAFADAHAAQAOAAAFgMIAAgJIgSAAQgQAAgBAKg");
	...
	this.shape_23.graphics.f("#FFFFFF").s().p("AAdArIAAgQIg5AAIAAAQIgMAAIAAgbIAEAAQAHgBADgKQACgHABgQIAAgYIA1AAIAAA6IAKAAIAAAbgAgMgSQgBAbgHAHIAmAAIAAguIgdAAg");
...
}).prototype = getMCSymbolPrototype(lib.Symbol73, new cjs.Rectangle(-444.4,-245.5,888.9,491), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_4
	this.instance_3 = new lib.videoframe_2();
...
// library properties:
lib.properties = {
	id: 'C2FF4C35834A4122BCF87252FB971D32',
	width: 850,
	height: 480,
	fps: 31,
	color: "#323232",
	opacity: 0.00,
	manifest: [
		{src:"images/2_index_atlas_P_1.png?1782140615753", id:"2_index_atlas_P_1"},
		{src:"images/2_index_atlas_NP_1.jpg?1782140615754", id:"2_index_atlas_NP_1"}
	],
	preloads: []
};
...
an.compositions['C2FF4C35834A4122BCF87252FB971D32'] = {
