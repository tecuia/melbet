...
lib.ssMetadata = [
		{name:"1_index_atlas_NP_1", frames: [[0,0,1152,928]]}
];
...
(lib._1_4_2 = function() {
	this.initialize(ss["1_index_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.btn3 = new lib.Symbol60();
	this.btn3.name = "btn3";
	this.btn3.setTransform(567.55,104.05,0.8689,1.1006,0,0,0,0.1,0.1);
	new cjs.ButtonHelper(this.btn3, 0, 1, 2, false, new lib.Symbol60(), 3);

	this.btn2 = new lib.Symbol60();
	this.btn2.name = "btn2";
	this.btn2.setTransform(441.6,104.05,0.8689,1.1006,0,0,0,0.1,0.1);
	new cjs.ButtonHelper(this.btn2, 0, 1, 2, false, new lib.Symbol60(), 3);

	this.btn1 = new lib.Symbol60();
	this.btn1.name = "btn1";
	this.btn1.setTransform(315.65,104.05,0.8689,1.1006,0,0,0,0.1,0.1);
	new cjs.ButtonHelper(this.btn1, 0, 1, 2, false, new lib.Symbol60(), 3);
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/1_index_atlas_NP_1.jpg?1782140352340", id:"1_index_atlas_NP_1"}
	],
	preloads: []
};
